...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center py-16">
        ...
        <div class="space-x-4">
            <a href="{{ route('posts.index') }}" class="inline-block px-6 py-3 bg-indigo-600 text-white font-medium rounded-md hover:bg-indigo-700">
                Browse Posts
            </a>
            @guest
            <a href="{{ route('register') }}" class="inline-block px-6 py-3 bg-gray-200 text-gray-800 font-medium rounded-md hover:bg-gray-300">
                Get Started
            </a>
            @else
            <a href="{{ route('posts.create') }}" class="inline-block px-6 py-3 bg-gray-200 text-gray-800 font-medium rounded-md hover:bg-gray-300">
                Create Post
            </a>
            @endguest
        </div>
