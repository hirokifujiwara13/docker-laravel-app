...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-lg">
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
            ...
            <a href="{{ route('posts.create') }}" class="px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700">
                Create New Post
            </a>
        </div>
        <div class="p-6">
            ...
            <div class="text-center">
                <a href="{{ route('posts.create') }}" class="text-indigo-600 hover:text-indigo-500">
