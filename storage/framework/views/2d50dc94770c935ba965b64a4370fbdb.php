...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg">
            ...
            <div class="p-6">
                <form method="POST" action="<?php echo e(route('test.queue')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-4">
                        <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Test Email Address</label>
                        <input id="email" type="email" name="email" value="<?php echo e(old('email', 'test@example.com')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="message" name="message" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('message', 'This is a test email from the Laravel Queue system!')); ?></textarea>
                    </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg">
            ...
            <div class="p-6">
                <form method="POST" action="<?php echo e(route('test.scheduler')); ?>">
                    <?php echo csrf_field(); ?>
...
function refreshLogs() {
    // Fetch queue status
    fetch('<?php echo e(route("test.queue-status")); ?>')
    ...
    // Fetch logs
    fetch('<?php echo e(route("test.logs")); ?>')
        .then(response => response.json())
        .then(data => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/test/index.blade.php ENDPATH**/ ?>