...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="content" name="content" rows="10" required
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input id="published_at" type="datetime-local" name="published_at" value="<?php echo e(old('published_at', now()->format('Y-m-d\TH:i'))); ?>"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center justify-between">
                    <a href="<?php echo e(route('posts.index')); ?>" class="text-gray-600 hover:text-gray-900">
                        Cancel
                    </a>
